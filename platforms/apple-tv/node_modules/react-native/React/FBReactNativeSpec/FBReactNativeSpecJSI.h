...
template <typename T>
class JSI_EXPORT NativeTVNavigationEventEmitterCxxSpec : public TurboModule {
public:
  static constexpr std::string_view kModuleName = "TVNavigationEventEmitter";

protected:
  NativeTVNavigationEventEmitterCxxSpec(std::shared_ptr<CallInvoker> jsInvoker) : TurboModule(std::string{NativeTVNavigationEventEmitterCxxSpec::kModuleName}, jsInvoker) {
    methodMap_["addListener"] = MethodMetadata {.argCount = 1, .invoker = __addListener};
    methodMap_["removeListeners"] = MethodMetadata {.argCount = 1, .invoker = __removeListeners};
    methodMap_["enableTVMenuKey"] = MethodMetadata {.argCount = 0, .invoker = __enableTVMenuKey};
    methodMap_["disableTVMenuKey"] = MethodMetadata {.argCount = 0, .invoker = __disableTVMenuKey};
    methodMap_["enableTVPanGesture"] = MethodMetadata {.argCount = 0, .invoker = __enableTVPanGesture};
    methodMap_["disableTVPanGesture"] = MethodMetadata {.argCount = 0, .invoker = __disableTVPanGesture};
    methodMap_["enableGestureHandlersCancelTouches"] = MethodMetadata {.argCount = 0, .invoker = __enableGestureHandlersCancelTouches};
    methodMap_["disableGestureHandlersCancelTouches"] = MethodMetadata {.argCount = 0, .invoker = __disableGestureHandlersCancelTouches};
  }
...
private:
  static jsi::Value __addListener(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
    static_assert(
      bridging::getParameterCount(&T::addListener) == 2,
      "Expected addListener(...) to have 2 parameters");
    bridging::callFromJs<void>(rt, &T::addListener,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule),
      count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt));return jsi::Value::undefined();
  }
  ...
  static jsi::Value __removeListeners(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
    static_assert(
      bridging::getParameterCount(&T::removeListeners) == 2,
      "Expected removeListeners(...) to have 2 parameters");
    bridging::callFromJs<void>(rt, &T::removeListeners,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule),
      count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber());return jsi::Value::undefined();
  }

  static jsi::Value __enableTVMenuKey(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::enableTVMenuKey) == 1,
      "Expected enableTVMenuKey(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::enableTVMenuKey,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __disableTVMenuKey(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::disableTVMenuKey) == 1,
      "Expected disableTVMenuKey(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::disableTVMenuKey,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __enableTVPanGesture(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::enableTVPanGesture) == 1,
      "Expected enableTVPanGesture(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::enableTVPanGesture,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __disableTVPanGesture(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::disableTVPanGesture) == 1,
      "Expected disableTVPanGesture(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::disableTVPanGesture,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __enableGestureHandlersCancelTouches(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
    ...
    bridging::callFromJs<void>(rt, &T::enableGestureHandlersCancelTouches,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __disableGestureHandlersCancelTouches(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
    ...
    bridging::callFromJs<void>(rt, &T::disableGestureHandlersCancelTouches,  static_cast<NativeTVNavigationEventEmitterCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }
};
